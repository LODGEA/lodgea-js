...
export default class LocationApi {
    ...
    */
     ...
     * @callback module:api/LocationApi~v1LocationSearchPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1LocationSearchPost200Response} data The data returned by the service call.
     ...
     * @param {module:model/LocationSearch} locationSearch Free-text search criteria
     * @param {module:api/LocationApi~v1LocationSearchPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1LocationSearchPost200Response}
     */
