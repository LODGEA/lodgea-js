...
export default class AvailabilityApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the v1AvailabilityGetPost operation.
     * @callback module:com.lodgea/com.lodgea.controllers/AvailabilityApi~v1AvailabilityGetPostCallback
     * @param {String} error Error message, if any.
     * @param {module:com.lodgea/com.lodgea.model/V1AvailabilityGetPost200Response} data The data returned by the service call.
     ...
     * @param {module:com.lodgea/com.lodgea.model/AvailabilityGet} availabilityGet Availability get parameter
     * @param {module:com.lodgea/com.lodgea.controllers/AvailabilityApi~v1AvailabilityGetPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:com.lodgea/com.lodgea.model/V1AvailabilityGetPost200Response}
     */
    v1AvailabilityGetPost(availabilityGet, callback) {
      let postBody = availabilityGet;
      // verify the required parameter 'availabilityGet' is set
      if (availabilityGet === undefined || availabilityGet === null) {
        throw new Error("Missing the required parameter 'availabilityGet' when calling v1AvailabilityGetPost");
      }
      ...
      let returnType = V1AvailabilityGetPost200Response;
      return this.apiClient.callApi(
        '/v1/availability/get', 'POST',
