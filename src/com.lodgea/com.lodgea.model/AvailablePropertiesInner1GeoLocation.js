...
class AvailablePropertiesInner1GeoLocation {
    ...
    /**
     * Validates the JSON data with respect to <code>AvailablePropertiesInner1GeoLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AvailablePropertiesInner1GeoLocation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AvailablePropertiesInner1GeoLocation.RequiredProperties) {
            if (!data[property]) {
...
AvailablePropertiesInner1GeoLocation.RequiredProperties = ["lng", "lat"];
