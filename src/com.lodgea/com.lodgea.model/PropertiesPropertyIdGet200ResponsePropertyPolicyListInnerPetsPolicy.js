...
class PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerPetsPolicy {
    ...
    /**
     * Validates the JSON data with respect to <code>PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerPetsPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerPetsPolicy</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerPetsPolicy.RequiredProperties) {
            if (!data[property]) {
...
PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerPetsPolicy.RequiredProperties = ["allowed", "byArrangement", "freeOfCharge"];
