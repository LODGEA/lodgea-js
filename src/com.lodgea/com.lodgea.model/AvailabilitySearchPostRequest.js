...
/**
 * The AvailabilitySearchPostRequest model module.
 * @module com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest
 * @version 1.1.5
 */
class AvailabilitySearchPostRequest {
    /**
     * Constructs a new <code>AvailabilitySearchPostRequest</code>.
     * @alias module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest
     * @param currencyCode {module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.CurrencyCodeEnum} The currency code of the currency in which the lowest price for each found location should be returned.<p>See also <a href=\"#currencycodes\">in the appendix</a>.</p>
     * @param languageCode {module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.LanguageCodeEnum} The language code of the language in which the descriptive texts for each found property should be returned.<p>Please note that beside the general restrictions listed below only languages configured during system setup for your respective tenant are allowed.</p><p>See also <a href=\"#isolanguage-codes\">in the appendix</a>.</p>
     */
    constructor(currencyCode, languageCode) { 
        
        AvailabilitySearchPostRequest.initialize(this, currencyCode, languageCode);
    }
     ...
     */
    static initialize(obj, currencyCode, languageCode) { 
        obj['currencyCode'] = currencyCode;
        obj['languageCode'] = languageCode;
    }

    /**
     * Constructs a <code>AvailabilitySearchPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest} obj Optional instance to populate.
     * @return {module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest} The populated <code>AvailabilitySearchPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AvailabilitySearchPostRequest();
            ...
            if (data.hasOwnProperty('earliestArrival')) {
                obj['earliestArrival'] = ApiClient.convertToType(data['earliestArrival'], 'String');
            }
            if (data.hasOwnProperty('latestReturn')) {
                obj['latestReturn'] = ApiClient.convertToType(data['latestReturn'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AvailabilitySearchPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AvailabilitySearchPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AvailabilitySearchPostRequest.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is an array
        if (!Array.isArray(data['childAgeList'])) {
            throw new Error("Expected the field `childAgeList` to be an array in the JSON data but got " + data['childAgeList']);
        }
        ...
        // ensure the json data is a string
        if (data['earliestArrival'] && !(typeof data['earliestArrival'] === 'string' || data['earliestArrival'] instanceof String)) {
            throw new Error("Expected the field `earliestArrival` to be a primitive type in the JSON string but got " + data['earliestArrival']);
        }
        // ensure the json data is a string
        if (data['latestReturn'] && !(typeof data['latestReturn'] === 'string' || data['latestReturn'] instanceof String)) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['unitTypeList'])) {
            throw new Error("Expected the field `unitTypeList` to be an array in the JSON data but got " + data['unitTypeList']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['unitAmenityList'])) {
            throw new Error("Expected the field `unitAmenityList` to be an array in the JSON data but got " + data['unitAmenityList']);
        }
        // ensure the json data is an array
...
AvailabilitySearchPostRequest.RequiredProperties = ["currencyCode", "languageCode"];
 ...
 * @default 2
 */
AvailabilitySearchPostRequest.prototype['adultCount'] = 2;

/**
 * The amount of children that will stay at the property.
 * @member {Number} childCount
 */
AvailabilitySearchPostRequest.prototype['childCount'] = undefined;
 ...
 */
AvailabilitySearchPostRequest.prototype['childAgeList'] = undefined;
 ...
 * @member {module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.CurrencyCodeEnum} currencyCode
 */
AvailabilitySearchPostRequest.prototype['currencyCode'] = undefined;

/**
 * The language code of the language in which the descriptive texts for each found property should be returned.<p>Please note that beside the general restrictions listed below only languages configured during system setup for your respective tenant are allowed.</p><p>See also <a href=\"#isolanguage-codes\">in the appendix</a>.</p>
 * @member {module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.LanguageCodeEnum} languageCode
 */
AvailabilitySearchPostRequest.prototype['languageCode'] = undefined;

/**
 * The unit system to use in the result.
 * @member {module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.UnitSystemEnum} unitSystem
 * @default 'metric'
 */
AvailabilitySearchPostRequest.prototype['unitSystem'] = 'metric';

/**
 * The desired minimum length of stay in nights.
 * @member {Number} minLengthOfStay
 */
AvailabilitySearchPostRequest.prototype['minLengthOfStay'] = undefined;

/**
 * The desired maximum length of stay in nights.
 * @member {Number} maxLengthOfStay
 */
AvailabilitySearchPostRequest.prototype['maxLengthOfStay'] = undefined;
 ...
 */
AvailabilitySearchPostRequest.prototype['locationName'] = undefined;
 ...
 * @member {module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.LocationTypeEnum} locationType
 */
AvailabilitySearchPostRequest.prototype['locationType'] = undefined;

/**
 * The earliest possible arrival date. Expects exactly the format of \"YYYY-MM-DD\".
 * @member {String} earliestArrival
 */
AvailabilitySearchPostRequest.prototype['earliestArrival'] = undefined;

/**
 * The latest possible departure date. Expects exactly the format of \"YYYY-MM-DD\".
 * @member {String} latestReturn
 */
AvailabilitySearchPostRequest.prototype['latestReturn'] = undefined;
 ...
 * @member {module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.SortEnum} sort
 */
AvailabilitySearchPostRequest.prototype['sort'] = undefined;
 ...
 * @member {Array.<module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.ServiceListEnum>} serviceList
 */
AvailabilitySearchPostRequest.prototype['serviceList'] = undefined;
 ...
 * @member {Array.<module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.TypeListEnum>} typeList
 */
AvailabilitySearchPostRequest.prototype['typeList'] = undefined;
 ...
 * @member {Array.<module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.UnitTypeListEnum>} unitTypeList
 */
AvailabilitySearchPostRequest.prototype['unitTypeList'] = undefined;
 ...
 * @member {Array.<module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.UnitAmenityListEnum>} unitAmenityList
 */
AvailabilitySearchPostRequest.prototype['unitAmenityList'] = undefined;
 ...
 * @member {Array.<module:com.lodgea/com.lodgea.model/AvailabilitySearchPostRequest.MealPlanListEnum>} mealPlanList
 */
AvailabilitySearchPostRequest.prototype['mealPlanList'] = undefined;
 ...
 * @readonly
 */
AvailabilitySearchPostRequest['CurrencyCodeEnum'] = {
 ...
 * @readonly
 */
AvailabilitySearchPostRequest['LanguageCodeEnum'] = {
 ...
 * @readonly
 */
AvailabilitySearchPostRequest['UnitSystemEnum'] = {
 ...
 * @readonly
 */
AvailabilitySearchPostRequest['LocationTypeEnum'] = {
 ...
 * @readonly
 */
AvailabilitySearchPostRequest['SortEnum'] = {
 ...
 * @readonly
 */
AvailabilitySearchPostRequest['ServiceListEnum'] = {
 ...
 * @readonly
 */
AvailabilitySearchPostRequest['TypeListEnum'] = {
...
/**
 * Allowed values for the <code>unitTypeList</code> property.
 * @enum {Number}
 * @readonly
 */
AvailabilitySearchPostRequest['UnitTypeListEnum'] = {
...
/**
 * Allowed values for the <code>unitAmenityList</code> property.
 * @enum {Number}
 * @readonly
 */
AvailabilitySearchPostRequest['UnitAmenityListEnum'] = {
 ...
 * @readonly
 */
AvailabilitySearchPostRequest['MealPlanListEnum'] = {
...
export default AvailabilitySearchPostRequest;
