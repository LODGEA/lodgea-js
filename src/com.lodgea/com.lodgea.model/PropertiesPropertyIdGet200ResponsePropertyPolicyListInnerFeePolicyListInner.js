...
class PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner {
    ...
    /**
     * Validates the JSON data with respect to <code>PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner.RequiredProperties) {
            if (!data[property]) {
...
PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner.RequiredProperties = ["typeCode", "chargeType", "chargeFrequencyCode", "currencyCode", "conditionList"];
