 ...
 * @module model/V1AvailabilitySearchPost200ResponseListInner
 * @version 1.0.0
 */
class V1AvailabilitySearchPost200ResponseListInner {
     ...
     * @alias module:model/V1AvailabilitySearchPost200ResponseListInner
     */
    constructor() { 
     ...
     * @param {module:model/V1AvailabilitySearchPost200ResponseListInner} obj Optional instance to populate.
     * @return {module:model/V1AvailabilitySearchPost200ResponseListInner} The populated <code>V1AvailabilitySearchPost200ResponseListInner</code> instance.
     */
...
/**
 * @member {module:model/V1AvailabilitySearchPost200ResponseListInnerGeo} geo
 */
V1AvailabilitySearchPost200ResponseListInner.prototype['geo'] = undefined;

/**
 * @member {Array.<module:model/V1AvailabilitySearchPost200ResponseListInnerMediaListInner>} mediaList
 */
V1AvailabilitySearchPost200ResponseListInner.prototype['mediaList'] = undefined;

/**
 * @member {Array.<module:model/V1AvailabilitySearchPost200ResponseListInnerAttractionListInner>} attractionList
 */
V1AvailabilitySearchPost200ResponseListInner.prototype['attractionList'] = undefined;

/**
 * @member {module:model/V1AvailabilitySearchPost200ResponseListInnerLowestPrice} lowestPrice
 */
