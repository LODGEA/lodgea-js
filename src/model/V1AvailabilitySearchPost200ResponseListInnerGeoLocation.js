 ...
 * @module model/V1AvailabilitySearchPost200ResponseListInnerGeoLocation
 * @version 1.0.0
 */
class V1AvailabilitySearchPost200ResponseListInnerGeoLocation {
     ...
     * @alias module:model/V1AvailabilitySearchPost200ResponseListInnerGeoLocation
     */
    constructor() { 
     ...
     * @param {module:model/V1AvailabilitySearchPost200ResponseListInnerGeoLocation} obj Optional instance to populate.
     * @return {module:model/V1AvailabilitySearchPost200ResponseListInnerGeoLocation} The populated <code>V1AvailabilitySearchPost200ResponseListInnerGeoLocation</code> instance.
     */
