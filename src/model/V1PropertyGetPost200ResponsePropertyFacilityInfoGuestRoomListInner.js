 ...
 * @module model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInner
 * @version 1.0.0
 */
class V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInner {
     ...
     * @alias module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInner
     */
    constructor() { 
     ...
     * @param {module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInner} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInner} The populated <code>V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInner</code> instance.
     */
...
/**
 * @member {Array.<module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerAmenityListInner>} amenityList
 */
...
/**
 * @member {Array.<module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMessageListInner>} messageList
 */
V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInner.prototype['messageList'] = undefined;

/**
 * @member {Array.<module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner>} mediaList
 */
