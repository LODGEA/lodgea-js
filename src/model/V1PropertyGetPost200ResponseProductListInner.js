 ...
 * @module model/V1PropertyGetPost200ResponseProductListInner
 * @version 1.0.0
 */
class V1PropertyGetPost200ResponseProductListInner {
     ...
     * @alias module:model/V1PropertyGetPost200ResponseProductListInner
     */
    constructor() { 
     ...
     * @param {module:model/V1PropertyGetPost200ResponseProductListInner} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponseProductListInner} The populated <code>V1PropertyGetPost200ResponseProductListInner</code> instance.
     */
...
/**
 * @member {Array.<module:model/V1PropertyGetPost200ResponseProductListInnerMealPlanListInner>} mealPlanList
 */
V1PropertyGetPost200ResponseProductListInner.prototype['mealPlanList'] = undefined;

/**
 * @member {Array.<module:model/V1PropertyGetPost200ResponseProductListInnerRoomTypeListInner>} roomTypeList
 */
...
/**
 * @member {Array.<module:model/V1PropertyGetPost200ResponseProductListInnerRatePlanListInner>} ratePlanList
 */
V1PropertyGetPost200ResponseProductListInner.prototype['ratePlanList'] = undefined;

/**
 * @member {module:model/V1PropertyGetPost200ResponseProductListInnerPolicyInfo} policyInfo
 */
