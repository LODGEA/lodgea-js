 ...
 * @module model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner
 * @version 1.0.0
 */
class V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner {
     ...
     * @alias module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner
     */
    constructor() { 
     ...
     * @param {module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner} The populated <code>V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner</code> instance.
     */
...
/**
 * @member {Array.<module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInnerTagListInner>} tagList
 */
...
/**
 * @member {Array.<module:model/V1PropertyGetPost200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInnerRoomAmenityListInner>} roomAmenityList
 */
