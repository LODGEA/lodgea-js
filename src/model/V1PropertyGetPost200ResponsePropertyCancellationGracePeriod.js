 ...
 * @module model/V1PropertyGetPost200ResponsePropertyCancellationGracePeriod
 * @version 1.0.0
 */
class V1PropertyGetPost200ResponsePropertyCancellationGracePeriod {
     ...
     * @alias module:model/V1PropertyGetPost200ResponsePropertyCancellationGracePeriod
     */
    constructor() { 
     ...
     * @param {module:model/V1PropertyGetPost200ResponsePropertyCancellationGracePeriod} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponsePropertyCancellationGracePeriod} The populated <code>V1PropertyGetPost200ResponsePropertyCancellationGracePeriod</code> instance.
     */
