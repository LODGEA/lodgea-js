 ...
 * @module model/V1PropertyGetPost200ResponsePropertyContactListInner
 * @version 1.0.0
 */
class V1PropertyGetPost200ResponsePropertyContactListInner {
     ...
     * @alias module:model/V1PropertyGetPost200ResponsePropertyContactListInner
     */
    constructor() { 
     ...
     * @param {module:model/V1PropertyGetPost200ResponsePropertyContactListInner} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponsePropertyContactListInner} The populated <code>V1PropertyGetPost200ResponsePropertyContactListInner</code> instance.
     */
...
/**
 * @member {Array.<module:model/V1PropertyGetPost200ResponsePropertyContactListInnerAddressListInner>} addressList
 */
