 ...
 * @module model/V1PropertyGetPost200ResponseProductListInnerMealPlanListInner
 * @version 1.0.0
 */
class V1PropertyGetPost200ResponseProductListInnerMealPlanListInner {
     ...
     * @alias module:model/V1PropertyGetPost200ResponseProductListInnerMealPlanListInner
     */
    constructor() { 
     ...
     * @param {module:model/V1PropertyGetPost200ResponseProductListInnerMealPlanListInner} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponseProductListInnerMealPlanListInner} The populated <code>V1PropertyGetPost200ResponseProductListInnerMealPlanListInner</code> instance.
     */
