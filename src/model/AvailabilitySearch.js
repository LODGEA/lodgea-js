...
class AvailabilitySearch {
     ...
     * @param {module:model/AvailabilitySearch} obj Optional instance to populate.
     * @return {module:model/AvailabilitySearch} The populated <code>AvailabilitySearch</code> instance.
     */
