 ...
 * @module model/V1PropertyGetPost200ResponsePropertyTransactionExternalListInner
 * @version 1.0.0
 */
class V1PropertyGetPost200ResponsePropertyTransactionExternalListInner {
     ...
     * @alias module:model/V1PropertyGetPost200ResponsePropertyTransactionExternalListInner
     */
    constructor() { 
     ...
     * @param {module:model/V1PropertyGetPost200ResponsePropertyTransactionExternalListInner} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponsePropertyTransactionExternalListInner} The populated <code>V1PropertyGetPost200ResponsePropertyTransactionExternalListInner</code> instance.
     */
