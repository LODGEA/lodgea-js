 ...
 * @module model/V1PropertyGetPost200ResponsePropertyPropertyInfoLocation
 * @version 1.0.0
 */
class V1PropertyGetPost200ResponsePropertyPropertyInfoLocation {
     ...
     * @alias module:model/V1PropertyGetPost200ResponsePropertyPropertyInfoLocation
     */
    constructor() { 
     ...
     * @param {module:model/V1PropertyGetPost200ResponsePropertyPropertyInfoLocation} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponsePropertyPropertyInfoLocation} The populated <code>V1PropertyGetPost200ResponsePropertyPropertyInfoLocation</code> instance.
     */
