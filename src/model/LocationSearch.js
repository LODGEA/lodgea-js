 ...
 * @module model/LocationSearch
 * @version 1.0.0
 */
class LocationSearch {
    /**
     * Constructs a new <code>LocationSearch</code>.
     * @alias module:model/LocationSearch
     ...
     * @param {module:model/LocationSearch} obj Optional instance to populate.
     * @return {module:model/LocationSearch} The populated <code>LocationSearch</code> instance.
     */
