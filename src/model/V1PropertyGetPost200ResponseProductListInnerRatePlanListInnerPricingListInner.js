 ...
 * @module model/V1PropertyGetPost200ResponseProductListInnerRatePlanListInnerPricingListInner
 * @version 1.0.0
 */
class V1PropertyGetPost200ResponseProductListInnerRatePlanListInnerPricingListInner {
     ...
     * @alias module:model/V1PropertyGetPost200ResponseProductListInnerRatePlanListInnerPricingListInner
     */
    constructor() { 
     ...
     * @param {module:model/V1PropertyGetPost200ResponseProductListInnerRatePlanListInnerPricingListInner} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponseProductListInnerRatePlanListInnerPricingListInner} The populated <code>V1PropertyGetPost200ResponseProductListInnerRatePlanListInnerPricingListInner</code> instance.
     */
...
/**
 * @member {module:model/V1PropertyGetPost200ResponseProductListInnerRatePlanListInnerPricingListInnerPriceList} priceList
 */
