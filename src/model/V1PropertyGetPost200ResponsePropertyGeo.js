...
class V1PropertyGetPost200ResponsePropertyGeo {
     ...
     * @param {module:model/V1PropertyGetPost200ResponsePropertyGeo} obj Optional instance to populate.
     * @return {module:model/V1PropertyGetPost200ResponsePropertyGeo} The populated <code>V1PropertyGetPost200ResponsePropertyGeo</code> instance.
     */
...
/**
 * @member {module:model/V1PropertyGetPost200ResponsePropertyGeoDe} de
 */
V1PropertyGetPost200ResponsePropertyGeo.prototype['de'] = undefined;

/**
 * @member {module:model/V1PropertyGetPost200ResponsePropertyGeoEn} en
 */
V1PropertyGetPost200ResponsePropertyGeo.prototype['en'] = undefined;

/**
 * @member {module:model/V1PropertyGetPost200ResponsePropertyGeoDa} da
 */
V1PropertyGetPost200ResponsePropertyGeo.prototype['da'] = undefined;

/**
 * @member {module:model/V1PropertyGetPost200ResponsePropertyGeoNl} nl
 */
