...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.InlineResponse2003PropertyGuestInfo();
  });
  ...
  describe('InlineResponse2003PropertyGuestInfo', function() {
    it('should create an instance of InlineResponse2003PropertyGuestInfo', function() {
      // uncomment below and update the code to test InlineResponse2003PropertyGuestInfo
      //var instance = new LodgeaJs.InlineResponse2003PropertyGuestInfo();
      //expect(instance).to.be.a(LodgeaJs.InlineResponse2003PropertyGuestInfo);
    });
