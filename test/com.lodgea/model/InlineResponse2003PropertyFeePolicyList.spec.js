...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.InlineResponse2003PropertyFeePolicyList();
  });
  ...
  describe('InlineResponse2003PropertyFeePolicyList', function() {
    it('should create an instance of InlineResponse2003PropertyFeePolicyList', function() {
      // uncomment below and update the code to test InlineResponse2003PropertyFeePolicyList
      //var instance = new LodgeaJs.InlineResponse2003PropertyFeePolicyList();
      //expect(instance).to.be.a(LodgeaJs.InlineResponse2003PropertyFeePolicyList);
    });
