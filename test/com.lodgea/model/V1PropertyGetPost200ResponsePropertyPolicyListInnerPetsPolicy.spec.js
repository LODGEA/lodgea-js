...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyPolicyListInnerPetsPolicy();
  });
  ...
  describe('V1PropertyGetPost200ResponsePropertyPolicyListInnerPetsPolicy', function() {
    it('should create an instance of V1PropertyGetPost200ResponsePropertyPolicyListInnerPetsPolicy', function() {
      // uncomment below and update the code to test V1PropertyGetPost200ResponsePropertyPolicyListInnerPetsPolicy
      //var instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyPolicyListInnerPetsPolicy();
      //expect(instance).to.be.a(LodgeaJs.V1PropertyGetPost200ResponsePropertyPolicyListInnerPetsPolicy);
    });
