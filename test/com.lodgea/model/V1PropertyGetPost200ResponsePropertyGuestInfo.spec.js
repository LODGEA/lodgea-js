...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyGuestInfo();
  });
  ...
  describe('V1PropertyGetPost200ResponsePropertyGuestInfo', function() {
    it('should create an instance of V1PropertyGetPost200ResponsePropertyGuestInfo', function() {
      // uncomment below and update the code to test V1PropertyGetPost200ResponsePropertyGuestInfo
      //var instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyGuestInfo();
      //expect(instance).to.be.a(LodgeaJs.V1PropertyGetPost200ResponsePropertyGuestInfo);
    });
