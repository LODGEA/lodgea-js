...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.LocationSearch();
  });
  ...
  describe('LocationSearch', function() {
    it('should create an instance of LocationSearch', function() {
      // uncomment below and update the code to test LocationSearch
      //var instance = new LodgeaJs.LocationSearch();
      //expect(instance).to.be.a(LodgeaJs.LocationSearch);
    });
