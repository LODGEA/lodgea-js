...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.InlineResponse2003PropertyContactList();
  });
  ...
  describe('InlineResponse2003PropertyContactList', function() {
    it('should create an instance of InlineResponse2003PropertyContactList', function() {
      // uncomment below and update the code to test InlineResponse2003PropertyContactList
      //var instance = new LodgeaJs.InlineResponse2003PropertyContactList();
      //expect(instance).to.be.a(LodgeaJs.InlineResponse2003PropertyContactList);
    });
