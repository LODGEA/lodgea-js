...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1PropertyListPost200Response();
  });
  ...
  describe('V1PropertyListPost200Response', function() {
    it('should create an instance of V1PropertyListPost200Response', function() {
      // uncomment below and update the code to test V1PropertyListPost200Response
      //var instance = new LodgeaJs.V1PropertyListPost200Response();
      //expect(instance).to.be.a(LodgeaJs.V1PropertyListPost200Response);
    });
