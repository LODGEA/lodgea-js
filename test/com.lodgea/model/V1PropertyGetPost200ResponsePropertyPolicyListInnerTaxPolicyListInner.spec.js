...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyPolicyListInnerTaxPolicyListInner();
  });
  ...
  describe('V1PropertyGetPost200ResponsePropertyPolicyListInnerTaxPolicyListInner', function() {
    it('should create an instance of V1PropertyGetPost200ResponsePropertyPolicyListInnerTaxPolicyListInner', function() {
      // uncomment below and update the code to test V1PropertyGetPost200ResponsePropertyPolicyListInnerTaxPolicyListInner
      //var instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyPolicyListInnerTaxPolicyListInner();
      //expect(instance).to.be.a(LodgeaJs.V1PropertyGetPost200ResponsePropertyPolicyListInnerTaxPolicyListInner);
    });
