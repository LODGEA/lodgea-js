...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyGeoDeLocation();
  });
  ...
  describe('V1PropertyGetPost200ResponsePropertyGeoDeLocation', function() {
    it('should create an instance of V1PropertyGetPost200ResponsePropertyGeoDeLocation', function() {
      // uncomment below and update the code to test V1PropertyGetPost200ResponsePropertyGeoDeLocation
      //var instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyGeoDeLocation();
      //expect(instance).to.be.a(LodgeaJs.V1PropertyGetPost200ResponsePropertyGeoDeLocation);
    });
