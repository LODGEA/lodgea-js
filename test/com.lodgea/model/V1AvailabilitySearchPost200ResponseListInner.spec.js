...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1AvailabilitySearchPost200ResponseListInner();
  });
  ...
  describe('V1AvailabilitySearchPost200ResponseListInner', function() {
    it('should create an instance of V1AvailabilitySearchPost200ResponseListInner', function() {
      // uncomment below and update the code to test V1AvailabilitySearchPost200ResponseListInner
      //var instance = new LodgeaJs.V1AvailabilitySearchPost200ResponseListInner();
      //expect(instance).to.be.a(LodgeaJs.V1AvailabilitySearchPost200ResponseListInner);
    });
