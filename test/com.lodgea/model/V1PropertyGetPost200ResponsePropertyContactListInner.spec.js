...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyContactListInner();
  });
  ...
  describe('V1PropertyGetPost200ResponsePropertyContactListInner', function() {
    it('should create an instance of V1PropertyGetPost200ResponsePropertyContactListInner', function() {
      // uncomment below and update the code to test V1PropertyGetPost200ResponsePropertyContactListInner
      //var instance = new LodgeaJs.V1PropertyGetPost200ResponsePropertyContactListInner();
      //expect(instance).to.be.a(LodgeaJs.V1PropertyGetPost200ResponsePropertyContactListInner);
    });
