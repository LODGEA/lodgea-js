...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.PropertiesPropertyIdGet200ResponsePropertyServiceListInner();
  });
  ...
  describe('PropertiesPropertyIdGet200ResponsePropertyServiceListInner', function() {
    it('should create an instance of PropertiesPropertyIdGet200ResponsePropertyServiceListInner', function() {
      // uncomment below and update the code to test PropertiesPropertyIdGet200ResponsePropertyServiceListInner
      //var instance = new LodgeaJs.PropertiesPropertyIdGet200ResponsePropertyServiceListInner();
      //expect(instance).to.be.a(LodgeaJs.PropertiesPropertyIdGet200ResponsePropertyServiceListInner);
    });
