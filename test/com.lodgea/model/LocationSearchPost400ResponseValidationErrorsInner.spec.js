...
(function(root, factory) {
  ...
  describe('LocationSearchPost400ResponseValidationErrorsInner', function() {
    it('should create an instance of LocationSearchPost400ResponseValidationErrorsInner', function() {
      // uncomment below and update the code to test LocationSearchPost400ResponseValidationErrorsInner
      //var instance = new LodgeaJs.LocationSearchPost400ResponseValidationErrorsInner();
