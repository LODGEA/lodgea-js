...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1PropertyGetPost200ResponseProductListInnerPolicyInfoCancellationPolicyListInner();
  });
  ...
  describe('V1PropertyGetPost200ResponseProductListInnerPolicyInfoCancellationPolicyListInner', function() {
    it('should create an instance of V1PropertyGetPost200ResponseProductListInnerPolicyInfoCancellationPolicyListInner', function() {
      // uncomment below and update the code to test V1PropertyGetPost200ResponseProductListInnerPolicyInfoCancellationPolicyListInner
      //var instance = new LodgeaJs.V1PropertyGetPost200ResponseProductListInnerPolicyInfoCancellationPolicyListInner();
      //expect(instance).to.be.a(LodgeaJs.V1PropertyGetPost200ResponseProductListInnerPolicyInfoCancellationPolicyListInner);
    });
