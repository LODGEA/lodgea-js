...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.InlineResponse200List();
  });
  ...
  describe('InlineResponse200List', function() {
    it('should create an instance of InlineResponse200List', function() {
      // uncomment below and update the code to test InlineResponse200List
      //var instance = new LodgeaJs.InlineResponse200List();
      //expect(instance).to.be.a(LodgeaJs.InlineResponse200List);
    });
