...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInner();
  });
  ...
  describe('PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInner', function() {
    it('should create an instance of PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInner', function() {
      // uncomment below and update the code to test PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInner
