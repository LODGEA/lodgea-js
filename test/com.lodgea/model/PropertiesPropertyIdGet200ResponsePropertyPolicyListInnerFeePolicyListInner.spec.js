...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner();
  });
  ...
  describe('PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner', function() {
    it('should create an instance of PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner', function() {
      // uncomment below and update the code to test PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner
      //var instance = new LodgeaJs.PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner();
      //expect(instance).to.be.a(LodgeaJs.PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner);
    });
