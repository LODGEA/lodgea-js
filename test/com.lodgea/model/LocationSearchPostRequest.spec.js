...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.LocationSearchPostRequest();
  });
  ...
  describe('LocationSearchPostRequest', function() {
    it('should create an instance of LocationSearchPostRequest', function() {
      // uncomment below and update the code to test LocationSearchPostRequest
      //var instance = new LodgeaJs.LocationSearchPostRequest();
      //expect(instance).to.be.a(LodgeaJs.LocationSearchPostRequest);
    });
