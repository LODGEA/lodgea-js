...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1AvailabilitySearchPost200ResponseListInnerLowestPrice();
  });
  ...
  describe('V1AvailabilitySearchPost200ResponseListInnerLowestPrice', function() {
    it('should create an instance of V1AvailabilitySearchPost200ResponseListInnerLowestPrice', function() {
      // uncomment below and update the code to test V1AvailabilitySearchPost200ResponseListInnerLowestPrice
      //var instance = new LodgeaJs.V1AvailabilitySearchPost200ResponseListInnerLowestPrice();
      //expect(instance).to.be.a(LodgeaJs.V1AvailabilitySearchPost200ResponseListInnerLowestPrice);
    });
