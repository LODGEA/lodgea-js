...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1PropertyGetPost200Response();
  });
  ...
  describe('V1PropertyGetPost200Response', function() {
    it('should create an instance of V1PropertyGetPost200Response', function() {
      // uncomment below and update the code to test V1PropertyGetPost200Response
      //var instance = new LodgeaJs.V1PropertyGetPost200Response();
      //expect(instance).to.be.a(LodgeaJs.V1PropertyGetPost200Response);
    });
