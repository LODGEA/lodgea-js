...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.InlineResponse2003PropertyAddressList();
  });
  ...
  describe('InlineResponse2003PropertyAddressList', function() {
    it('should create an instance of InlineResponse2003PropertyAddressList', function() {
      // uncomment below and update the code to test InlineResponse2003PropertyAddressList
      //var instance = new LodgeaJs.InlineResponse2003PropertyAddressList();
      //expect(instance).to.be.a(LodgeaJs.InlineResponse2003PropertyAddressList);
    });
