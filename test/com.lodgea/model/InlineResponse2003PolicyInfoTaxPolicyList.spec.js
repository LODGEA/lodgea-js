...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.InlineResponse2003PolicyInfoTaxPolicyList();
  });
  ...
  describe('InlineResponse2003PolicyInfoTaxPolicyList', function() {
    it('should create an instance of InlineResponse2003PolicyInfoTaxPolicyList', function() {
      // uncomment below and update the code to test InlineResponse2003PolicyInfoTaxPolicyList
      //var instance = new LodgeaJs.InlineResponse2003PolicyInfoTaxPolicyList();
      //expect(instance).to.be.a(LodgeaJs.InlineResponse2003PolicyInfoTaxPolicyList);
    });
