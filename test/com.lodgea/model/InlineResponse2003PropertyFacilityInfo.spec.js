...
(function(root, factory) {
  ...
  describe('InlineResponse2003PropertyFacilityInfo', function() {
    it('should create an instance of InlineResponse2003PropertyFacilityInfo', function() {
      // uncomment below and update the code to test InlineResponse2003PropertyFacilityInfo
      //var instance = new LodgeaJs.InlineResponse2003PropertyFacilityInfo();
