...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.InlineResponse2004PricingList();
  });
  ...
  describe('InlineResponse2004PricingList', function() {
    it('should create an instance of InlineResponse2004PricingList', function() {
      // uncomment below and update the code to test InlineResponse2004PricingList
      //var instance = new LodgeaJs.InlineResponse2004PricingList();
      //expect(instance).to.be.a(LodgeaJs.InlineResponse2004PricingList);
    });
