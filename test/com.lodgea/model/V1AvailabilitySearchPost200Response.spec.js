...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1AvailabilitySearchPost200Response();
  });
  ...
  describe('V1AvailabilitySearchPost200Response', function() {
    it('should create an instance of V1AvailabilitySearchPost200Response', function() {
      // uncomment below and update the code to test V1AvailabilitySearchPost200Response
      //var instance = new LodgeaJs.V1AvailabilitySearchPost200Response();
      //expect(instance).to.be.a(LodgeaJs.V1AvailabilitySearchPost200Response);
    });
