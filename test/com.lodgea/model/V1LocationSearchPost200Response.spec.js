...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.V1LocationSearchPost200Response();
  });
  ...
  describe('V1LocationSearchPost200Response', function() {
    it('should create an instance of V1LocationSearchPost200Response', function() {
      // uncomment below and update the code to test V1LocationSearchPost200Response
      //var instance = new LodgeaJs.V1LocationSearchPost200Response();
      //expect(instance).to.be.a(LodgeaJs.V1LocationSearchPost200Response);
    });
