...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.PropertyApi();
  });
  ...
  describe('PropertyApi', function() {
    describe('v1PropertyGetPost', function() {
      it('should call v1PropertyGetPost successfully', function(done) {
        //uncomment below and update the code to test v1PropertyGetPost
        //instance.v1PropertyGetPost(function(error) {
