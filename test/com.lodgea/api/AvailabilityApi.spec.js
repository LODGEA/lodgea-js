...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.AvailabilityApi();
  });
  ...
  describe('AvailabilityApi', function() {
    describe('v1AvailabilitySearchPost', function() {
      it('should call v1AvailabilitySearchPost successfully', function(done) {
        //uncomment below and update the code to test v1AvailabilitySearchPost
        //instance.v1AvailabilitySearchPost(function(error) {
