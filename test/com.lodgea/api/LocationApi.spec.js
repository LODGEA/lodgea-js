...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LodgeaJs.LocationApi();
  });
  ...
  describe('LocationApi', function() {
    describe('v1LocationSearchPost', function() {
      it('should call v1LocationSearchPost successfully', function(done) {
        //uncomment below and update the code to test v1LocationSearchPost
        //instance.v1LocationSearchPost(function(error) {
